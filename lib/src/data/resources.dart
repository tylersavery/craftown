...
class Resources {
  ...
  static Resource get iron => Resource(
        identifier: "iron",
        name: "Iron Ore",
        description: "Basic iron ore mined from the ground.",
        namePlural: "Iron Ore",
  ...
  static Resource get stone => Resource(
        identifier: "stone",
        name: "Stone Ore",
        description: "Basic stone mined from the ground.",
  ...
  static Resource get clay => Resource(
        ...
        name: "Clay",
        namePlural: "Clay",
        description: "Basic clay minded from the ground.",
  ...
  static Resource get copper => Resource(
        ...
        description: "Basic copper ore mined from the ground.",
  ...
  static Resource get wood => Resource(
        ...
        name: "Wood",
        namePlural: "Wood",
        description: "Basic wood mined from trees.",
  ...
  static Resource get water => Resource(
        ...
        name: "Water",
        namePlural: "Water",
        description: "Good ol' H2O. Drink it when you are thirsty.",
  ...
  static Resource get straw => Resource(
        identifier: "straw",
        namePlural: "Straw",
        description: "Basic straw harvested from the ground.",
  ...
  static Resource get soil => Resource(
          ...
          name: "Soil",
          namePlural: "Soil",
          description: "You can place this to create your own farm land.",
  ...
  static Resource get potato => Resource(
        ...
        description: "Eat them to restore hunger or sell them in a community chest.",
        name: "Potato",
        namePlural: "Potatos",
  ...
  static Resource get potatoSeed => Resource(
        ...
        name: "Potato Seed",
        description: "Plant these at your farm to grow potatoes.",
  ...
  static Resource get carrotSeed => Resource(
        ...
        description: "Plant these at your farm to grow carrots.",
        isSeed: true,
  ...
  static Resource get garlicSeed => Resource(
        ...
        description: "Plant these at your farm to grow garlic.",
        isSeed: true,
  ...
  static Resource get tomatoSeed => Resource(
        ...
        description: "Plant these at your farm to grow tomatos.",
        isSeed: true,
...
// Smeltables
  ...
  static Resource get ironPlate => Resource(
        ...
        description: "Used to craft more advanced items. Must be smelted in a smelter.",
        secondsToSmelt: 10,
...
// Constructables (1 ingredient)
  ...
  static Resource get barrel => Resource(
        ...
        description: "Can be used to store liquids to free up some inventory space.",
        name: "Barrel",
        namePlural: "Barrels",
        secondsToCraft: 3,
        canPlace: true,
  ...
  static Resource get chest => Resource(
        ...
        name: "Chest",
        namePlural: "Chests",
        description: "Can be used to store solids to free up some inventory space.",
        secondsToCraft: 3,
        canPlace: true,
        placementWidth: 30,
        placementHeight: 22,
  ...
  static Resource get pick => Resource(
        ...
        name: "Pick",
        namePlural: "Picks",
        description: "For mining iron, copper, and stone.",
        secondsToCraft: 3,
        amountPerSlot: 1,
        equipsTool: "pick",
        ingredients: [
  ...
  static Resource get shovel => Resource(
        ...
        description: "For prepping your farm land.",
        name: "Shovel",
        namePlural: "Shovels",
        secondsToCraft: 3,
        amountPerSlot: 1,
  ...
  static Resource get sythe => Resource(
        ...
        description: "For harvesting wheat and crops.",
        name: "Sythe",
        namePlural: "Sythes",
        secondsToCraft: 3,
        amountPerSlot: 1,
  ...
  static Resource get woodenBucket => Resource(
        ...
        description: "For gathering water.",
        secondsToCraft: 10,
        amountPerSlot: 1,
        canPlace: true,
        canPickUp: true,
  ...
  static Resource get soup => Resource(
        ...
        name: "Soup",
        namePlural: "Soup",
        description: "Restores hunger and thirst stats.",
        secondsToCraft: 1,
        amountPerSlot: 10,
        ingredients: [
  ...
  static Resource get tent => Resource(
        ...
        name: "Tent",
        namePlural: "Tents",
        description: "Restores energy stats",
        secondsToCraft: 8,
        canPlace: true,
        canPickUp: true,
        placementWidth: 34,
  ...
  static Resource get communityChest => Resource(
        ...
        description: "Can be used to store items and/or sell certain items to the community to earn coins.",
        secondsToCraft: 10,
        canPlace: true,
        placementWidth: 30,
        placementHeight: 22,
  ...
  static Resource get smelterA => Resource(
      ...
      description: "For smelting raw resources. Requires power.",
      placementWidth: 32,
      placementHeight: 26,
      amountPerSlot: 1,
      name: "Smelter",
  ...
  static Resource get constructorA => Resource(
        ...
        description: "Automate crafting of certain recipes. Requires power.",
        placementWidth: 26,
        placementHeight: 38,
        amountPerSlot: 1,
        name: "Constructor",
  ...
  static Resource get lightMiner => Resource(
      ...
      description: "Automate mining of straw, wood, and clay. Requires power.",
      name: "Light Miner",
  ...
  static Resource get heavyMiner => Resource(
      ...
      description: "Automates mining of straw, wood, clay, stone, iron, and copper. Requires power.",
      secondsToCraft: 5,
      canPlace: true,
      placementWidth: 12,
      placementHeight: 23,
  ...
  static Resource get well => Resource(
      ...
      name: "Well",
      namePlural: "Wells",
      description: "Build this on the ground to collect water automatically.",
      secondsToCraft: 5,
      canPlace: true,
      placementWidth: 48,
      placementHeight: 57,
  ...
  static Resource get powerGeneratorWood => Resource(
          ...
          description: "Generate power using wood as fuel.",
          placementWidth: 32,
          placementHeight: 74,
          canPlace: true,
          canPickUp: true,
  ...
  static Resource get powerGeneratorSolar => Resource(
          ...
          description: "Generate power using the sun as fuel.",
          placementWidth: 32,
          placementHeight: 32,
          canPlace: true,
          canPickUp: true,
